...
RUN DEBIAN_FRONTEND='noninteractive' apt-get install -y --no-install-recommends sudo libgtk2.0-dev jack2 libjack-jackd2-dev liblo-dev libportmidi-dev libpulse-dev 
